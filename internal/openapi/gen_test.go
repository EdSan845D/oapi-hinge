...
func docCreatedHandler(ctx context.Context, _ contract.NoReq, _ any) (contract.Response[handlers.User], error) {
	return contract.Response[handlers.User]{Status: http.StatusCreated, Data: handlers.User{}}, nil
}
